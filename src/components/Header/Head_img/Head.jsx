...
const Head = () => {
    return (
        ...
        <div className="hero min-h-screen rounded-3xl" style={{backgroundImage: 'url(https://i.ibb.co/PN87MZ9/mid-shot-chef-holding-plate-with-pasta-making-ok-sign.jpg)'}}>
